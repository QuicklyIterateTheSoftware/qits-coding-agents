 ...
 * container's by construction, so those predicates are constants and the methods collapse into the
 * five below.
 *
...
public final class CommandStore {
   ...
   * this container's owner drove in an earlier container — a resume of such a
